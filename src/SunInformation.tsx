      ...
      <div className="border-2 h-fit rounded-lg p-4 w-fit bg-white mx-auto mb-2">
        ...
        <div className="w-fit mx-auto mt-[4px] min-w-[280px]">
          <div className="flex">
            <span>Highest:</span>
            <span className="flex-1 border-b border-dotted border-black mx-1 mb-1"></span>
            <span className="w-16 text-left">61.5°</span>
          </div>
          <div className="flex">
            <span>Average:</span>
            <span className="flex-1 border-b border-dotted border-black mx-1 mb-1"></span>
            <span className="w-16 text-left">38.5°</span>
          </div>
          <div className="flex">
            <span>Lowest:</span>
            <span className="flex-1 border-b border-dotted border-black mx-1 mb-1"></span>
            <span className="w-16 text-left">15.5°</span>
          </div>
        </div>
        ...
        <div className="w-fit mx-auto mt-1 min-w-[280px]">
          <div className="flex">
            <span>Highest:</span>
            <span className="flex-1 border-b border-dotted border-black mx-1 mb-1"></span>
            <span className="w-24 text-left">16hrs 32mins</span>
          </div>
          <div className="flex">
            <span>Average:</span>
            <span className="flex-1 border-b border-dotted border-black mx-1 mb-1"></span>
